...
import static com.javatunes.personnel.EmployeeFactory.createEmployee;
...
public class EmployeeFactoryTest {
  ...
  public void testCreateEmployeeSalaried() {
    SalariedEmployee emp = (SalariedEmployee) createEmployee(seMap);
  ...
  public void testCreateEmployeeHourly() {
    // TODO
    HourlyEmployee emp = (HourlyEmployee) createEmployee(seMap);
    assertEquals("Jackie", emp.getName());
    assertEquals(Date.valueOf("1990-08-24"), emp.getHireDate());
  ...
  public void testCreateEmployeeInvalidTypeThrowsIllegalArgumentException() {
    // TODO
    var invalidInput = Map.of("type","SO", "name","Freddy Kreuger");
    createEmployee(invalidInput);
